...
describe('Deve completar o pré cadastro', () => {
    ...
    it('Deve completar o pré cadastro com sucesso usando comandos customizados', () => {
        cy.preCadastro(faker.internet.email(), 'senha@forte', 'Tiago', 'Teste') //criando o comando customizado usa-se aqui
        //importante ressaltar que pode-se passar os parâmtros da biblioteca Faker também
    });
